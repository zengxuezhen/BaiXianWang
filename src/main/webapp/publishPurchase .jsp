                    ...
                    <div class="member-column">
                       <div class="controls">
                         ...
                         <form action="addPurchaseOrder" method="post">
                            <p>采购单名称：</p>
                            <input type="text" class="input03 w320" name="purchaseOrderName">
                        </div>
                         <div class="controls">
                            <p>采购物品：</p>
                            <input type="text" class="input03 w320" name="productName">
                        </div>
                         <div class="controls">
                            <p>产地要求：</p>
                            <input type="text" class="input03 w320" name="origin">
                        </div>
                        <div class="controls">
                            <p>规格型号：</p>
                            <input type="text" class="input03 w320" name="specification">
                        </div>
                        <div class="controls">
                            <p>级别要求：</p>
                            <input type="text" class="input03 w320" name="level">
                        </div>
                        <div class="controls">
                            <p>仓库要求：</p>
                            <input type="text" class="input03 w320" name="warehouse">
                        </div>
                        <div class="controls">
                            <p>期/现货：</p>
                           <select class="w250" name="futureSpot">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="input03 w125" name="price">
                            <i>元/千克</i>
                        </div>
                        <div class="controls">
                            <p>采购说明：</p>
                        ...
                        <div class="controls">
                            <p>付款方式：</p>
                            <input type="text" class="input03 w320" name="paymentMethod">
                            <i>如预付款、货到付款、30%定金70%交货时付等</i>
                        </div>
                        <div class="controls">
                            <p>发票类型：</p>
                            <div class="controls-radio">
                                 <input type="radio" name="invoiceType" class="radio" >
                                 <i>增值税发票</i>
                            </div>
                            <div class="controls-radio">
                                 <input type="radio" name="invoiceType" class="radio">
                        ...
                        <div class="controls">
                            <p>采购截止时间：</p>
                            <input type="text" class="input03 w155" name="deadline">
                        </div>
                    </div>
                    <div class="member-column">
                        ...
                        <div class="controls">
                            <p>联系人：</p>
                            <input type="text" class="input03 w320" name="contact">
                        </div>
                        
                        <div class="controls">
                            <p>手机号：</p>
                            <input type="text" class="input03 w320" name="phone">
                        </div>
