         ...
         <div class="member-right">
            ...
            <div class="member-main">
                <div class="member-column">
                    <div class="member-detailtit">${purchaseOrder.purchaseOrderName}</div>
                    <div class="detail-con">
                        <dl>
                            <dt>产品名称：</dt>
                            <dd><p>${purchaseOrder.productName}</p></dd>
                            <dt>产地要求：</dt>
                            <dd>
                                <p>${purchaseOrder.origin}</p>
                            </dd>
                            <dt>规格型号：</dt>
                            <dd>
                                <p>${purchaseOrder.specification}</p>
                            </dd>
                            <dt>级别要求：</dt>
                            <dd>
                                <p>${purchaseOrder.level}</p>
                            </dd>
                            <dt>仓库要求：</dt>
                            <dd>
                                <p>${purchaseOrder.warehouse}</p>
                            </dd>
                            <dt>期/现货：</dt>
                            <dd>
                                <p> <c:if test="${purchaseOrder.futureSpot==0 }">期货</c:if>
									<c:if test="${purchaseOrder.futureSpot==1 }">现货</c:if>  </p>
                            </dd>
                            <dt>价格要求：</dt>
                            <dd>
                                <p>${purchaseOrder.price}</p>
                            </dd>
                            <dt>采购说明：</dt>
                            <dd>
                                <p>${purchaseOrder.purchaseDescription}</p>
                            </dd>
                            <dt>付款方式：</dt>
                            <dd>
                                <p>${purchaseOrder.paymentMethod}</p>
                            </dd>
                            <dt>发票类型：</dt>
                            <dd>
                                <p>${purchaseOrder.invoiceType}</p>
                            </dd>
                            <dt>收货地址：</dt>
                            <dd>
